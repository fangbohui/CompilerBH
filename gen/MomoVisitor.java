...
public interface MomoVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitArrayExpression(MomoParser.ArrayExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code constantStatement}
	 * labeled alternative in {@link MomoParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstantStatement(MomoParser.ConstantStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code idenStatement}
	 * labeled alternative in {@link MomoParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdenStatement(MomoParser.IdenStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIdType(MomoParser.IdTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code thisConstant}
	 * labeled alternative in {@link MomoParser#constant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitThisConstant(MomoParser.ThisConstantContext ctx);
}