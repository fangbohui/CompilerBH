 ...
 */
public class ModInstruction extends MULMODInstruction {
	private ModInstruction(VirtualRegister dest, Operand src1, Operand src2) {
		super(dest, src1, src2);
	}

	public static Instruction getInstruction(VirtualRegister dest, Operand src1, Operand src2) {
		return new ModInstruction(dest, src1, src2);
	}

	public String OPname() {
		return "FBH is sad...QAQ";
	}
}
