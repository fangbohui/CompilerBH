 ...
 */
public class LeftShiftInstruction extends BinaryInstruction {
	private LeftShiftInstruction(VirtualRegister dest, Operand src1, Operand src2) {
		super(dest, src1, src2);
	}

	public static Instruction getInstruction(VirtualRegister dest, Operand src1, Operand src2) {
		return new LeftShiftInstruction(dest, src1, src2);
	}
