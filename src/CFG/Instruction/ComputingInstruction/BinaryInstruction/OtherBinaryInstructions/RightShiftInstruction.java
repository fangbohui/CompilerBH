 ...
 */
public class RightShiftInstruction extends BinaryInstruction {
	private RightShiftInstruction(VirtualRegister dest, Operand src1, Operand src2) {
		super(dest, src1, src2);
	}

	public static Instruction getInstruction(VirtualRegister dest, Operand src1, Operand src2) {
		return new RightShiftInstruction(dest, src1, src2);
	}
