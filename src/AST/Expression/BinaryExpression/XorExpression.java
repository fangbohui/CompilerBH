...
public class XorExpression extends BinaryExpression {
	private XorExpression(Type type, Boolean isLV, Expression leftExpression, Expression rightExpression) {
	...
	public static Expression getExpression(Expression leftExpression, Expression rightExpression) {
		if (leftExpression.type instanceof IntType && rightExpression.type instanceof IntType) {
			...
			return new XorExpression(IntType.getType(), false, leftExpression, rightExpression);
		}
	...
	public void emit(ArrayList<Instruction> instructions) {
		...
		instructions.add(XorInstruction.getInstruction((VirtualRegister) operand, leftExpression.operand, rightExpression.operand));
	}
}
