...
import CFG.Instruction.ComputingInstruction.BinaryInstruction.OtherBinaryInstructions.GreaterInstruction;
...
public class GreaterExpression extends BinaryExpression {
	private GreaterExpression(Type type, Boolean isLV, Expression leftExpression, Expression rightExpression) {
	...
	public void emit(ArrayList<Instruction> instructions) {
		...
		instructions.add(GreaterInstruction.getInstruction((VirtualRegister) operand, leftExpression.operand, rightExpression.operand));
	}
}
