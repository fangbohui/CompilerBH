...
public class ModExpression extends BinaryExpression {
	private ModExpression(Type type, Boolean isLV, Expression leftExpression, Expression rightExpression) {
	...
	public static Expression getExpression(Expression leftExpression, Expression rightExpression) {
		if (leftExpression.type instanceof IntType && rightExpression.type instanceof IntType) {
			...
			return new ModExpression(IntType.getType(), false, leftExpression, rightExpression);
		}
	...
	public void emit(ArrayList<Instruction> instructions) {
		...
		instructions.add(ModInstruction.getInstruction((VirtualRegister) operand, leftExpression.operand, rightExpression.operand));
	}
}
