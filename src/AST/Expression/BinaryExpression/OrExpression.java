...
import CFG.Instruction.ComputingInstruction.BinaryInstruction.OtherBinaryInstructions.OrInstruction;
...
public class OrExpression extends BinaryExpression {
	private OrExpression(Type type, Boolean isLV, Expression leftExpression, Expression rightExpression) {
	...
	public static Expression getExpression(Expression leftExpression, Expression rightExpression) {
		if (leftExpression.type instanceof IntType && rightExpression.type instanceof IntType) {
			...
			return new OrExpression(IntType.getType(), false, leftExpression, rightExpression);
		}
	...
	public void emit(ArrayList<Instruction> instructions) {
		...
		instructions.add(OrInstruction.getInstruction((VirtualRegister) operand, leftExpression.operand, rightExpression.operand));
	}
}
